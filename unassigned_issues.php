    ...
    <tr>
	  ...
	  <div style="height:480px; overflow:scroll">
		...
		<tr>
			...
			<td><select name="district_name" id="district_name" onkeypress="submitOnEnter(this, event);"><option value='' selected="selected">Select Region First</option>
			</select></td>
			...
			<td><input name="date_created" type="text" id="date_created" onkeypress="submitOnEnter(this, event);"/></td>
			<td>
		...
		// Get page data
			...
			issue.createdby=users.emp_no AND 
			...
			issue.date_created LIKE'%$f_date_created%' AND
			issue.createdby LIKE'%$f_createdby%' AND
		...
		?>
			...
			<td><input name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $rows['issueid']; ?>"><span class="style1">*</span></td>    
		  </tr>
		<?php 
		$indexcounter++;
		} ?>
