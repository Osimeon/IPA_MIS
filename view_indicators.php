...
?>
    ...
    <tr>
	  ...
	  <legend align="center"><h2>PERFORMANCE INDICATORS LIST</h2></legend>
		...
		<thead>
		  <tr>
			...
			<?php
			// Get page data
			$sel = mysql_query("SELECT * FROM performance_indicators,department WHERE performance_indicators.dep_id=department.dep_id");
			while($row=mysql_fetch_array($sel))
				{
					?>
					<tr >
						<td width="2%"><?php echo $row["indicator_id"]; ?></td> 
						<td><?php echo $row["dep_name"]; ?></td> 
						<td><?php echo $row["indicator"]; ?></td>
						<td><?php echo $row["dep_desc"]; ?></td>						
						<td width="1%"><a href="edit_indicator.php?indicator_id=<?php echo $row["indicator_id"]; ?>"><img src='images/edit.png ' alt="Edit" width="16" height="16" border="0" /></td>     
		  </tr>
		  <?php  } ?>
		</table><p />
		</div>
