...
?>
    ...
    <tr>
	  ...
	  <legend align="center"><h2>USER ROLE LIST</h2></legend>
		...
		<thead>
		  <tr>
			...
			<?php
			// Get page data
			$sel = mysql_query("SELECT * FROM user_roles");
			while($row=mysql_fetch_array($sel))
				{
					?>
					<tr >
						<td width="2%"><?php echo $row["role_id"]; ?></td> 
						<td><?php echo $row["job_title"]; ?></td> 
						<td width="1%"><a href="edit_role.php?role_id=<?php echo $row["role_id"]; ?>"><img src='images/edit.png ' alt="Edit" width="16" height="16" border="0" /></td>     
		  </tr>
		  <?php  } ?>
		</table>
		</div>
