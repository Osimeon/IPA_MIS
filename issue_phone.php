...
<body>
    ...
    <tr>
	  ...
	  <legend align="center"><h2>PHONES IN STORE</h2></legend>
	  <div align="center">
	  ...
	  <div style="height:520px; overflow:scroll">
		...
		<?php
		// Get page data
			$sel = "SELECT * FROM phone_inventory,make,manufacture WHERE
			phone_inventory.status ='In Store' AND 
			phone_inventory.make_id =make.make_id AND 
			make.manufacture_id=manufacture.manufacture_id";
		...
		?>
			...
			<td width="100"><a href="update_phone.php?phone_id=<?php echo $rows["phone_id"]; ?>" onclick="javascript:void window.open('update_phone.php?phone_id=<?php echo $rows["phone_id"]; ?>','1390461620844','width=400,height=350,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,left=450,top=50');return false;"><img border='0' src='issue_phone.png' width='100' height='25' /></a></td>			
		  </tr>
		<?php 
		$indexcounter++;
		} ?>
