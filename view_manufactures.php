...
?>
    ...
    <tr>
	  ...
	  <legend align="center"><h2>PRODUCT MANUFACTURES LIST</h2></legend>
		...
		<thead>
		  <tr>
			...
			<?php
			// Get page data
			$sel = mysql_query("SELECT * FROM manufacture");
			while($row=mysql_fetch_array($sel))
				{
					?>
					<tr >
						<td width="2%"><?php echo $row["manufacture_id"]; ?></td> 
						<td><?php echo $row["manufacture"]; ?></td> 
						<td width="1%"><a href="edit_manufacture.php?manufacture_id=<?php echo $row["manufacture_id"]; ?>"><img src='images/edit.png ' alt="Edit" width="16" height="16" border="0" /></td>     
		  </tr>
		  <?php  } ?>
		</table>
		</div>
